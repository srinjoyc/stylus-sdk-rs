//! Implements an Ethereum BLS signature verification contract on Stylus
//! written in Rust.
//!
//! Warning: THIS CODE AND THE CRYPTOGRAPHY BEHIND IT HAVE NOT BEEN AUDITED. This is only
